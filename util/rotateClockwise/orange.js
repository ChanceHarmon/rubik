                ...
                .then(() => {
                  client.query(sql5)
                    ...
                    .then(() => {
                      ...
                      let sql = `UPDATE white SET positions='${travelLogArray[1][0].positions.split(',')[2]},${travelLogArray[1][1].positions.split(',')[2]},${travelLogArray[1][2].positions.split(',')[2]}' WHERE id=1;`;
                      client.query(sql)
                        .then(() => {
                          let sql = `UPDATE blue SET positions='${travelLogArray[1][0].positions.split(',')[0]},${travelLogArray[1][0].positions.split(',')[1]},${travelLogArray[3][2].positions.split(',')[2]}' WHERE id=1;`;
                          client.query(sql)
                            .then(() => {
                                    ...
                                    .then(() => {
                                      ...
                                      client.query(sql)
                                        .then(() => {
                                          ...
                                          client.query(sql)
                                            .then(() => {
                                              let sql = `UPDATE green SET positions='${travelLogArray[0][0].positions.split(',')[1]},${travelLogArray[2][1].positions.split(',')[1]},${travelLogArray[2][1].positions.split(',')[2]}' WHERE id=2;`;
                                              client.query(sql)
                                                .then(() => {
                                                  let sql = `UPDATE green SET positions='${travelLogArray[0][0].positions.split(',')[0]},${travelLogArray[2][2].positions.split(',')[1]},${travelLogArray[2][2].positions.split(',')[2]}' WHERE id=3;`;
                                                  client.query(sql)
                                                    .then(() => {
                                                      return travelLog;
                                                    })
