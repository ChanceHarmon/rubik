...
let sqlArray1 = [
  `UPDATE orange SET row='top', positions='yellow:00,yellow:01,red:02', face_id=1 WHERE id=1;`,
...
let sqlArray2 = [
  `UPDATE orange SET row='top', positions='green:00,red:01,blue:20', face_id=1 WHERE id=1;`,
  `UPDATE orange SET row='middle', positions='red:12,orange:11,red:21', face_id=1 WHERE id=2;`,
  `UPDATE orange SET row='bottom', positions='blue:00,red:10,green:20', face_id=1 WHERE id=3;`,
  `UPDATE green SET row='top', positions='yellow:02,yellow:10,orange:20', face_id=2 WHERE id=1;`,
  `UPDATE green SET row='middle', positions='orange:10,green:11,orange:21', face_id=2 WHERE id=2;`,
  `UPDATE green SET row='bottom', positions='yellow:22,yellow:21,green:22', face_id=2 WHERE id=3;`,
  `UPDATE white SET row='top', positions='blue:02,green:21,orange:22', face_id=3 WHERE id=1;`,
  `UPDATE white SET row='middle', positions='blue:01,white:11,green:21', face_id=3 WHERE id=2;`,
  `UPDATE white SET row='bottom', positions='orange:02,white:10,blue:22', face_id=3 WHERE id=3;`,
  `UPDATE blue SET row='top', positions='red:22,yellow:12,orange:20', face_id=4 WHERE id=1;`,
  `UPDATE blue SET row='middle', positions='white:01,blue:11,blue:10', face_id=4 WHERE id=2;`,
  `UPDATE blue SET row='bottom', positions='yellow:20,red:01,red:00', face_id=4 WHERE id=3;`,
  `UPDATE red SET row='top', positions='yellow:20,orange:10,white:00', face_id=5 WHERE id=1;`,
  `UPDATE red SET row='middle', positions='green:01,red:11,orange:01', face_id=5 WHERE id=2;`,
  `UPDATE red SET row='bottom', positions='orange:00,green::12,white:00', face_id=5 WHERE id=3;`,
  `UPDATE yellow SET row='top', positions='green:02,orange:12,yellow:00', face_id=6 WHERE id=1;`,
  `UPDATE yellow SET row='middle', positions='yellow:01,yellow:11,white:21', face_id=6 WHERE id=2;`,
  `UPDATE yellow SET row='bottom', positions='yellow:22,blue:12,red:02', face_id=6 WHERE id=3;`
];
